...
<#
    ...
    .EXAMPLE
        ...
        C:\PS> Invoke-MSOLEnum -UserList .\userlist.txt -Password TESTPASS -URL https://api-gateway-endpoint-id.execute-api.us-east-1.amazonaws.com/fireprox -Domain company.com -OutFile valid-users.txt
        Description
        -----------
